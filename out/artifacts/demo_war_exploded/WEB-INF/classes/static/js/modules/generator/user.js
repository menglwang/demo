$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [			
			...
			{ label: '用户状态 0-正常 1-封禁', name: 'status', index: 'status', width: 80 }, 			
			{ label: '用户账号创建时间', name: 'createTime', index: 'create_time', width: 80 }, 			
			{ label: '上次登录时间', name: 'lastLoginTime', index: 'last_login_time', width: 80 }, 			
			{ label: '上次更新记录时间', name: 'lastUpdateTime', index: 'last_update_time', width: 80 }, 			
